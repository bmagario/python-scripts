...
def webApiGet(methodName, instanceName, clientRequestId):
    ...
    requestPath = ws + '/' + methodName + '/' + \
        instanceName + '?clientRequestId=' + clientRequestId
...
datapath = 'C:\TEMP\endpoints_clientid_latestversion.txt'
...
if version['latest'] > latestVersion:
    ...
    print(','.join(
        sorted(set([url for (category, url, tcpPorts, udpPorts) in flatUrls]))))
else:
